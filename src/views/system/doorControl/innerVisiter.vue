<template>
    <v-content>
        <ul class="header">
            <el-button type="primary" size="small" @click="dialogFormVisible1=true;"><i class="el-icon-plus"></i>使用身份证添加(门禁卡)</el-button>
            <el-button type="primary" size="small" @click="dialogFormVisible2=true;"><i class="el-icon-plus"></i>手动添加(门禁卡)</el-button>
            <el-button type="primary" size="small" @click="dialogFormVisible3=true;"><i class="el-icon-plus"></i>台内人员添加(门禁卡)</el-button>
            <el-button type="primary" size="small" @click="dialogFormVisible4=true;"><i class="el-icon-plus"></i>使用身份证添加(二维码)</el-button>
            <el-button type="primary" size="small" @click="dialogFormVisible5=true;"><i class="el-icon-plus"></i>手动添加(二维码)</el-button>
        </ul>
        <ul class="query">
            <li class="item">
                <span>起止时间:</span>
        ...
        <!-- 第三个弹框 -->
        <el-dialog title="台内人员添加" :visible.sync="dialogFormVisible3" width="600px" class="dialog3">
            <el-form :model="form" size="mini">
                <div class="left">
                    <div class="left_1">
                        <div class="left_1_1">
                            ...
                            <el-form-item label="人员单位" :label-width="formLabelWidth">
                                <el-input v-model="form.name" autocomplete="off" size="mini"></el-input>
                            </el-form-item>
                            <el-form-item label="有效起始" :label-width="formLabelWidth">
                                <el-input v-model="form.name" autocomplete="off" size="mini"></el-input>
                        ...
                        <div class="left_1_2">
                            <el-image
                                style="width: 90px; height: 120px; margin-bottom:52px;"
                                src="https://fuss10.elemecdn.com/e/5d/4a731a90594a4af544c0c25941171jpeg.jpeg"
                                fit="fill">
                            </el-image>
                            <el-form-item label="是否启用" :label-width="formLabelWidth" style="text-align:left;">
        ...
        <!-- 第四个弹框 -->
        <el-dialog title="使用身份证添加访客信息(二维码)" :visible.sync="dialogFormVisible4" width="1130px" class="dialog1"> 
            <el-form :model="form" size="mini">
                <div class="left">
                    <div class="left_1">
                        <div class="left_1_1">
        ...
        <!-- 第五个弹框 -->
        <el-dialog title="手动添加访客信息(二维码)" :visible.sync="dialogFormVisible5" width="1130px" class="dialog1"> 
            <el-form :model="form" size="mini">
                <div class="left">
                    <div class="left_1">
                        <div class="left_1_1">
